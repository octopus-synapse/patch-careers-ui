...
- Name: infrastructure/e2e/auth/onboarding.spec.ts >> Onboarding page >> Authenticated (fresh user) >> should not display Back button on first step
- Location: test/infrastructure/e2e/auth/onboarding.spec.ts:156:3
