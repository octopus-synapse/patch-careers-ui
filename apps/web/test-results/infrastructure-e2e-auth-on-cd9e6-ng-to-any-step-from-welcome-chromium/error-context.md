...
- Name: infrastructure/e2e/auth/onboarding-flows.spec.ts >> Onboarding Flows >> sidebar allows jumping to any step from welcome
- Location: test/infrastructure/e2e/auth/onboarding-flows.spec.ts:278:2
