...
- Name: infrastructure/e2e/auth/onboarding.spec.ts >> Onboarding page >> Authenticated (fresh user) >> should navigate back to previous step
- Location: test/infrastructure/e2e/auth/onboarding.spec.ts:202:3
