...
- Name: infrastructure/e2e/auth/onboarding-flows.spec.ts >> Onboarding Flows >> review step shows complete button
- Location: test/infrastructure/e2e/auth/onboarding-flows.spec.ts:401:2
