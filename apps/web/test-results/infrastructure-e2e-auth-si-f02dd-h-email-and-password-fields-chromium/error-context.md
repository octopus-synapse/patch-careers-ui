...
- Name: infrastructure/e2e/auth/signin.spec.ts >> Signin page >> should display signin form with email and password fields
- Location: test/infrastructure/e2e/auth/signin.spec.ts:24:2
