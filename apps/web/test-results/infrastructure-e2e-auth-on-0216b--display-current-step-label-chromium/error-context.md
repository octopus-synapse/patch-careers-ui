...
- Name: infrastructure/e2e/auth/onboarding.spec.ts >> Onboarding page >> Authenticated (fresh user) >> should display current step label
- Location: test/infrastructure/e2e/auth/onboarding.spec.ts:134:3
