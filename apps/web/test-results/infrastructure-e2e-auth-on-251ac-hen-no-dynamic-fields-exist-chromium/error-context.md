...
- Name: infrastructure/e2e/auth/onboarding.spec.ts >> Onboarding page >> Authenticated (fresh user) >> should render step content even when no dynamic fields exist
- Location: test/infrastructure/e2e/auth/onboarding.spec.ts:232:3
