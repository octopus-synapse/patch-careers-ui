...
- Name: infrastructure/e2e/auth/onboarding.spec.ts >> Onboarding page >> Authenticated (fresh user) >> should display Continue button
- Location: test/infrastructure/e2e/auth/onboarding.spec.ts:145:3
