...
- Name: infrastructure/e2e/auth/onboarding-flows.spec.ts >> Onboarding Flows >> section step shows add button
- Location: test/infrastructure/e2e/auth/onboarding-flows.spec.ts:262:2
