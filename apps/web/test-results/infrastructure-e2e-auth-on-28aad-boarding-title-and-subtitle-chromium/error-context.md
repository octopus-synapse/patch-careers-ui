...
- Name: infrastructure/e2e/auth/onboarding.spec.ts >> Onboarding page >> Authenticated (fresh user) >> should display onboarding title and subtitle
- Location: test/infrastructure/e2e/auth/onboarding.spec.ts:83:3
