...
- Name: infrastructure/e2e/auth/onboarding.spec.ts >> Onboarding page >> Authenticated (fresh user) >> should display progress bar in sidebar
- Location: test/infrastructure/e2e/auth/onboarding.spec.ts:108:3
