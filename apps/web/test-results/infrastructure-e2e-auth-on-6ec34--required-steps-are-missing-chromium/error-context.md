...
- Name: infrastructure/e2e/auth/onboarding-flows.spec.ts >> Onboarding Flows >> complete button is disabled when required steps are missing
- Location: test/infrastructure/e2e/auth/onboarding-flows.spec.ts:415:2
