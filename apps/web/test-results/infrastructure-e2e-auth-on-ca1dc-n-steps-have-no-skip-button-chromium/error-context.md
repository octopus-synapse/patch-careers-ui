...
- Name: infrastructure/e2e/auth/onboarding-flows.spec.ts >> Onboarding Flows >> non-section steps have no skip button
- Location: test/infrastructure/e2e/auth/onboarding-flows.spec.ts:516:2
