...
- Name: infrastructure/e2e/auth/signup.spec.ts >> Signup page >> should render without errors when backend is unreachable
- Location: test/infrastructure/e2e/auth/signup.spec.ts:4:2
