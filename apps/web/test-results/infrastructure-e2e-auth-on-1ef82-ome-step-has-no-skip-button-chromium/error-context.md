...
- Name: infrastructure/e2e/auth/onboarding-flows.spec.ts >> Onboarding Flows >> welcome step has no skip button
- Location: test/infrastructure/e2e/auth/onboarding-flows.spec.ts:502:2
