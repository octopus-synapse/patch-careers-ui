...
- Name: infrastructure/e2e/auth/onboarding.spec.ts >> Onboarding page >> Authenticated (fresh user) >> should show Back button after advancing
- Location: test/infrastructure/e2e/auth/onboarding.spec.ts:188:3
