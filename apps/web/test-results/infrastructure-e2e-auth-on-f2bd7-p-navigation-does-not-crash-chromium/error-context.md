...
- Name: infrastructure/e2e/auth/onboarding-flows.spec.ts >> Onboarding Flows >> rapid step navigation does not crash
- Location: test/infrastructure/e2e/auth/onboarding-flows.spec.ts:447:2
