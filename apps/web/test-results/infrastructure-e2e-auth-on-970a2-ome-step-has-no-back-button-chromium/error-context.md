...
- Name: infrastructure/e2e/auth/onboarding-flows.spec.ts >> Onboarding Flows >> welcome step has no back button
- Location: test/infrastructure/e2e/auth/onboarding-flows.spec.ts:488:2
