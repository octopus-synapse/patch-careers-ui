...
const steps = [
	...
	{ id: 'section:education', label: 'Education' },
	{
		...
		label: 'Theme',
		data: [
			{ id: 'classic', name: 'Classic', thumbnailUrl: '/themes/classic.png' }
		]
	}
];
...
const fullSession = {
	...
	professionalProfile: { headline: 'Developer', summary: 'Full-stack dev with 5 years of experience building web apps.' },
	sections: [
		{
			sectionTypeKey: 'work',
	...
	it('renders all completed sections from session data', () => {
		...
		render(StepReview, {
			props: {
				session: fullSession,
				steps,
				completedSteps: ['personal-info', 'username', 'professional-profile', 'section:work', 'section:education', 'template'],
				ongoto
			}
		});
