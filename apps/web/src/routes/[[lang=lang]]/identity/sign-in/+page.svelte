...
import { createLogin, sessionQueryKey, isApiError } from 'api-client';
import { loginMutationRequestSchema } from 'api-client/zod';
...
const form = createForm({
  schema: loginMutationRequestSchema,
			...
			<div class="w-full max-w-[340px]">
				...
				<footer class="mt-12 text-center">
					<p class="text-xs text-gray-500 dark:text-neutral-500">
						...
						<a href="/identity/sign-up" class="ml-1 font-bold text-gray-800 dark:text-neutral-200 hover:underline">
