  ...
  <div class="w-full max-w-[360px] text-center" role="status" aria-live="polite">
    ...
    {:else if status === 'success'}
      ...
      <p class="mt-2 text-sm text-gray-500 dark:text-neutral-500">
        <a href="/dashboard" class="font-medium text-cyan-500 hover:underline">Ir para o dashboard →</a>
      </p>
    {:else}
      ...
      <p class="mt-4 text-sm">
        <a href="/login" class="font-medium text-cyan-500 hover:underline">Voltar ao login</a>
      </p>
    {/if}
  </div>
</main>
