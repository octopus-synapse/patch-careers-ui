...
export function BrandMark({ size = 28 }: { size?: number }): ReactElement {
  return (
    <Svg width={size} height={size} viewBox="0 0 28 28">
      ...
      <Rect x={6} y={5} width={4} height={12} rx={1} fill={authTokens.surface} />
      <Rect x={10} y={5} width={6} height={4} rx={1} fill={authTokens.surface} />
      <Rect x={10} y={9} width={6} height={3} rx={1} fill={authTokens.surface} />
    ...
    <View style={shellStyles.root}>
      ...
      >
        ...
        >
          ...
          <Animated.View entering={FadeIn.duration(400)} style={shellStyles.masthead}>
...
function EditorialLabel({
  ...
  return (
    <RNText style={[labelStyles.label, error ? labelStyles.labelError : labelStyles.labelNormal]}>
      {children}
    </RNText>
  );
}
      ...
      <UnderlineInput
        ...
        rightSlot={
          <Pressable
            ...
            hitSlop={10}
            style={({ pressed }) => [underlineStyles.eyeButton, pressed && { opacity: 0.5 }]}
...
export function OrDivider({ text }: { text: string }): ReactElement {
  return (
    <Animated.View entering={FadeIn.delay(600).duration(500)} style={dividerStyles.row}>
...
export function FooterPrompt({
  ...
  return (
    <Animated.View entering={FadeIn.delay(900).duration(500)} style={footerStyles.wrapper}>
