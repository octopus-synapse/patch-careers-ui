...
#
# Source-of-truth: octopus-workflows/_tooling/pin-actions.sh
# This file is a manual mirror. When the upstream changes, re-copy here.
# Future: publish as a shared npm util once stable.
#
# Usage:
