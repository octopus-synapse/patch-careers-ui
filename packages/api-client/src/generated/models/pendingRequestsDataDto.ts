 ...
 */
import type { PendingRequestsDataDtoPendingRequests } from './pendingRequestsDataDtoPendingRequests';

export interface PendingRequestsDataDto {
  pendingRequests: PendingRequestsDataDtoPendingRequests;
}
