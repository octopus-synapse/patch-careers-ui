...
export type ResumeQualityResponseDtoIssuesItemSeverity = typeof ResumeQualityResponseDtoIssuesItemSeverity[keyof typeof ResumeQualityResponseDtoIssuesItemSeverity];


export const ResumeQualityResponseDtoIssuesItemSeverity = {
  low: 'low',
  medium: 'medium',
  high: 'high',
} as const;
