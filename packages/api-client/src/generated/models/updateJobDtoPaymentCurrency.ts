 ...
 * @nullable
 */
export type UpdateJobDtoPaymentCurrency = typeof UpdateJobDtoPaymentCurrency[keyof typeof UpdateJobDtoPaymentCurrency] | null;


export const UpdateJobDtoPaymentCurrency = {
  BRL: 'BRL',
  USD: 'USD',
  EUR: 'EUR',
  GBP: 'GBP',
