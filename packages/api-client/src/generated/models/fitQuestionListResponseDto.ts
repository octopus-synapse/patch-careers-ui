 ...
 */
import type { FitQuestionListResponseDtoItemsItem } from './fitQuestionListResponseDtoItemsItem';

export interface FitQuestionListResponseDto {
  items: FitQuestionListResponseDtoItemsItem[];
}
