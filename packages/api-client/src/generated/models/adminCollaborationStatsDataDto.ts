 ...
 */
import type { AdminCollaborationStatsDataDtoByRoleItem } from './adminCollaborationStatsDataDtoByRoleItem';

export interface AdminCollaborationStatsDataDto {
  totalCollaborations: number;
  byRole: AdminCollaborationStatsDataDtoByRoleItem[];
}
