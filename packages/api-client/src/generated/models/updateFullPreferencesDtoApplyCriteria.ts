 ...
 */
import type { UpdateFullPreferencesDtoApplyCriteriaPaymentCurrenciesItem } from './updateFullPreferencesDtoApplyCriteriaPaymentCurrenciesItem';
import type { UpdateFullPreferencesDtoApplyCriteriaRemotePoliciesItem } from './updateFullPreferencesDtoApplyCriteriaRemotePoliciesItem';

export type UpdateFullPreferencesDtoApplyCriteria = {
  /**
     * @minimum 0
     * @maximum 100
     */
  ...
  /** @maxItems 10 */
  seniorities?: string[];
  remotePolicies?: UpdateFullPreferencesDtoApplyCriteriaRemotePoliciesItem[];
  paymentCurrencies?: UpdateFullPreferencesDtoApplyCriteriaPaymentCurrenciesItem[];
  /** @minimum 0 */
  minSalaryUsd?: number;
  /** @maxLength 4000 */
  defaultCover?: string;
