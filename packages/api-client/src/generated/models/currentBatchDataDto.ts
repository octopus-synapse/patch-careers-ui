 ...
 */
import type { CurrentBatchDataDtoBatch } from './currentBatchDataDtoBatch';

export interface CurrentBatchDataDto {
  /**
     * This week's batch or null if none active
     * @nullable
     */
  batch: CurrentBatchDataDtoBatch;
}
