...
export type CreateJobDtoPaymentCurrency = typeof CreateJobDtoPaymentCurrency[keyof typeof CreateJobDtoPaymentCurrency];


export const CreateJobDtoPaymentCurrency = {
  BRL: 'BRL',
  USD: 'USD',
  EUR: 'EUR',
  GBP: 'GBP',
