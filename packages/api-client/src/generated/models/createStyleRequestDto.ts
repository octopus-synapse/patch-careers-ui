 ...
 */
import type { CreateStyleRequestDtoLayoutKind } from './createStyleRequestDtoLayoutKind';
import type { CreateStyleRequestDtoSectionStyles } from './createStyleRequestDtoSectionStyles';
import type { CreateStyleRequestDtoStyleConfig } from './createStyleRequestDtoStyleConfig';

export interface CreateStyleRequestDto {
  /**
     * @minLength 1
     * @maxLength 120
     */
  ...
  layoutKind: CreateStyleRequestDtoLayoutKind;
  styleConfig: CreateStyleRequestDtoStyleConfig;
  sectionStyles?: CreateStyleRequestDtoSectionStyles;
}
