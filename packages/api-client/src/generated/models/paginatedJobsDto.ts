 ...
 */
import type { PaginatedJobsDtoItemsItem } from './paginatedJobsDtoItemsItem';
import type { PaginatedJobsDtoPagination } from './paginatedJobsDtoPagination';

export interface PaginatedJobsDto {
  items: PaginatedJobsDtoItemsItem[];
  pagination: PaginatedJobsDtoPagination;
}
