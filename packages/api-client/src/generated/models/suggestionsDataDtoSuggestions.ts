 ...
 */
import type { SuggestionsDataDtoSuggestionsDataItem } from './suggestionsDataDtoSuggestionsDataItem';

export type SuggestionsDataDtoSuggestions = {
  data: SuggestionsDataDtoSuggestionsDataItem[];
  total: number;
  page: number;
  limit: number;
  totalPages: number;
