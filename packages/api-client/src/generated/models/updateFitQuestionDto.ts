 ...
 */
import type { UpdateFitQuestionDtoDimension } from './updateFitQuestionDtoDimension';
import type { UpdateFitQuestionDtoScaleType } from './updateFitQuestionDtoScaleType';

export interface UpdateFitQuestionDto {
  dimension?: UpdateFitQuestionDtoDimension;
  /** @minLength 1 */
  textEn?: string;
  /** @minLength 1 */
  textPtBr?: string;
  scaleType?: UpdateFitQuestionDtoScaleType;
  /** @exclusiveMinimum 0 */
  weight?: number;
  isActive?: boolean;
