 ...
 */
import type { MatchCandidatesDataDtoCandidatesItemFit } from './matchCandidatesDataDtoCandidatesItemFit';

export type MatchCandidatesDataDtoCandidatesItem = {
  userId: string;
  /** @nullable */
  ...
  bio: string | null;
  primaryStack: string[];
  fit: MatchCandidatesDataDtoCandidatesItemFit;
};
