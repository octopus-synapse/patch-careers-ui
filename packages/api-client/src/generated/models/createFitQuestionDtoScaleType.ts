...
export type CreateFitQuestionDtoScaleType = typeof CreateFitQuestionDtoScaleType[keyof typeof CreateFitQuestionDtoScaleType];


export const CreateFitQuestionDtoScaleType = {
  likert5: 'likert5',
  binary: 'binary',
} as const;
