 ...
 */
import type { MatchBreakdownDtoSubScoresFit } from './matchBreakdownDtoSubScoresFit';
import type { MatchBreakdownDtoSubScoresKeyword } from './matchBreakdownDtoSubScoresKeyword';
import type { MatchBreakdownDtoSubScoresRequirements } from './matchBreakdownDtoSubScoresRequirements';
import type { MatchBreakdownDtoSubScoresSemantic } from './matchBreakdownDtoSubScoresSemantic';

export type MatchBreakdownDtoSubScores = {
  keyword: MatchBreakdownDtoSubScoresKeyword;
  requirements: MatchBreakdownDtoSubScoresRequirements;
  semantic: MatchBreakdownDtoSubScoresSemantic;
  fit: MatchBreakdownDtoSubScoresFit;
};
