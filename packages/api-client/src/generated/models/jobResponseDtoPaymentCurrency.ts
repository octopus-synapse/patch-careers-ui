 ...
 * @nullable
 */
export type JobResponseDtoPaymentCurrency = typeof JobResponseDtoPaymentCurrency[keyof typeof JobResponseDtoPaymentCurrency] | null;


export const JobResponseDtoPaymentCurrency = {
  BRL: 'BRL',
  USD: 'USD',
  EUR: 'EUR',
  GBP: 'GBP',
