 ...
 */
import type { ViewCareerGraphDataDtoBucketsItem } from './viewCareerGraphDataDtoBucketsItem';
import type { ViewCareerGraphDataDtoCurrent } from './viewCareerGraphDataDtoCurrent';
import type { ViewCareerGraphDataDtoProjectionsItem } from './viewCareerGraphDataDtoProjectionsItem';
import type { ViewCareerGraphDataDtoUser } from './viewCareerGraphDataDtoUser';

export interface ViewCareerGraphDataDto {
  stack: string[];
  user: ViewCareerGraphDataDtoUser;
  totalPeers: number;
  /** @nullable */
  current: ViewCareerGraphDataDtoCurrent;
  buckets: ViewCareerGraphDataDtoBucketsItem[];
  projections: ViewCareerGraphDataDtoProjectionsItem[];
}
