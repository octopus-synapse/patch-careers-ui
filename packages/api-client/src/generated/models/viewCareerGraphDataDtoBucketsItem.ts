 ...
 */
import type { ViewCareerGraphDataDtoBucketsItemTopJobTitlesItem } from './viewCareerGraphDataDtoBucketsItemTopJobTitlesItem';

export type ViewCareerGraphDataDtoBucketsItem = {
  experienceYears: number;
  peerCount: number;
  topJobTitles: ViewCareerGraphDataDtoBucketsItemTopJobTitlesItem[];
};
