 ...
 */
import type { AdminCollaborationsListDataDtoItemsItemResume } from './adminCollaborationsListDataDtoItemsItemResume';
import type { AdminCollaborationsListDataDtoItemsItemUser } from './adminCollaborationsListDataDtoItemsItemUser';

export type AdminCollaborationsListDataDtoItemsItem = {
  id: string;
  resumeId: string;
  userId: string;
  role: string;
  ...
  user: AdminCollaborationsListDataDtoItemsItemUser;
  resume: AdminCollaborationsListDataDtoItemsItemResume;
};
