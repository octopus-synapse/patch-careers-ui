...
export type CreateJobDtoMinEnglishLevel = typeof CreateJobDtoMinEnglishLevel[keyof typeof CreateJobDtoMinEnglishLevel];


export const CreateJobDtoMinEnglishLevel = {
  BASIC: 'BASIC',
