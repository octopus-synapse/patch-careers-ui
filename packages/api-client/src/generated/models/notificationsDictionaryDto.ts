 ...
 */
import type { NotificationsDictionaryDtoEntries } from './notificationsDictionaryDtoEntries';
import type { NotificationsDictionaryDtoLocale } from './notificationsDictionaryDtoLocale';

export interface NotificationsDictionaryDto {
  /** Locale the strings are in (negotiated from Accept-Language). */
  locale: NotificationsDictionaryDtoLocale;
  /** Map from NotificationType value to its template in the negotiated locale. */
  entries: NotificationsDictionaryDtoEntries;
}
