...
export interface AdminAnalyticsOverviewDataDto {
  userGrowth: AdminAnalyticsOverviewDataDtoUserGrowthItem[];
  resumesByLanguage: AdminAnalyticsOverviewDataDtoResumesByLanguageItem[];
  atsScoreDistribution: AdminAnalyticsOverviewDataDtoAtsScoreDistributionItem[];
