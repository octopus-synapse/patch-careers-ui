...
export type UsernameAvailabilityDataDtoReason = typeof UsernameAvailabilityDataDtoReason[keyof typeof UsernameAvailabilityDataDtoReason];


export const UsernameAvailabilityDataDtoReason = {
  taken: 'taken',
  reserved: 'reserved',
