...
export type SetProficiencyDtoProficiency = typeof SetProficiencyDtoProficiency[keyof typeof SetProficiencyDtoProficiency];


export const SetProficiencyDtoProficiency = {
  BEGINNER: 'BEGINNER',
