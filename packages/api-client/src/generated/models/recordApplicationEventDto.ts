 ...
 */
import type { RecordApplicationEventDtoType } from './recordApplicationEventDtoType';

export interface RecordApplicationEventDto {
  type: RecordApplicationEventDtoType;
  /** @maxLength 2000 */
  note?: string;
  occurredAt?: string;
}
