 ...
 */
import type { MatchBreakdownDtoEffectiveWeights } from './matchBreakdownDtoEffectiveWeights';
import type { MatchBreakdownDtoSubScores } from './matchBreakdownDtoSubScores';
...
export interface MatchBreakdownDto {
  /**
     ...
     */
  overallScore: number;
  subScores: MatchBreakdownDtoSubScores;
  effectiveWeights: MatchBreakdownDtoEffectiveWeights;
  rulesVersion: string;
  computedAt: string;
}
