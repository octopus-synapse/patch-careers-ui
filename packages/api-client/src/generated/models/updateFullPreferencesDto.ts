 ...
 */
import type { UpdateFullPreferencesDtoApplyCriteria } from './updateFullPreferencesDtoApplyCriteria';
import type { UpdateFullPreferencesDtoApplyMode } from './updateFullPreferencesDtoApplyMode';
import type { UpdateFullPreferencesDtoDigestFrequency } from './updateFullPreferencesDtoDigestFrequency';

export interface UpdateFullPreferencesDto {
  theme?: string;
  palette?: string;
  bannerColor?: string;
  /** @maxLength 100 */
  ...
  digestFrequency?: UpdateFullPreferencesDtoDigestFrequency;
  ...
  applyMode?: UpdateFullPreferencesDtoApplyMode;
  applyCriteria?: UpdateFullPreferencesDtoApplyCriteria;
}
