 ...
 */
import type { RageApplyFailureDto } from './rageApplyFailureDto';

export interface RageApplyResultDto {
  /** How many jobs we tried to apply to */
  attempted: number;
  /** Successful submissions */
  submitted: number;
  /** Skipped because user already applied */
  skippedExisting: number;
  /** Per-job failures with reason */
