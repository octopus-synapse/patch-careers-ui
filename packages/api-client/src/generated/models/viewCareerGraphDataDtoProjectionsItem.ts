 ...
 */
import type { ViewCareerGraphDataDtoProjectionsItemBucket } from './viewCareerGraphDataDtoProjectionsItemBucket';

export type ViewCareerGraphDataDtoProjectionsItem = {
  yearsAhead: number;
  /** @nullable */
  bucket: ViewCareerGraphDataDtoProjectionsItemBucket;
};
