 ...
 */
import type { UpsertJobFitProfileRequestDtoSliders } from './upsertJobFitProfileRequestDtoSliders';

export interface UpsertJobFitProfileRequestDto {
  sliders: UpsertJobFitProfileRequestDtoSliders;
}
