 ...
 * @nullable
 */
export type PaginatedJobsDtoItemsItemRemotePolicy = typeof PaginatedJobsDtoItemsItemRemotePolicy[keyof typeof PaginatedJobsDtoItemsItemRemotePolicy] | null;


export const PaginatedJobsDtoItemsItemRemotePolicy = {
  REMOTE: 'REMOTE',
  HYBRID: 'HYBRID',
  ONSITE: 'ONSITE',
} as const;
