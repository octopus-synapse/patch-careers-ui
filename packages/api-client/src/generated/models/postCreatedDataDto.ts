...
import type { PostCreatedDataDtoCodeSnippet } from './postCreatedDataDtoCodeSnippet';

export interface PostCreatedDataDto {
  id: string;
  authorId: string;
  type: string;
  subtype?: string;
  ...
  pollDeadline?: string;
  votesCount: number;
  codeSnippet?: PostCreatedDataDtoCodeSnippet;
  likesCount: number;
