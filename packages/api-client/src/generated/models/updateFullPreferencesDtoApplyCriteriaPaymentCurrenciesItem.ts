...
export type UpdateFullPreferencesDtoApplyCriteriaPaymentCurrenciesItem = typeof UpdateFullPreferencesDtoApplyCriteriaPaymentCurrenciesItem[keyof typeof UpdateFullPreferencesDtoApplyCriteriaPaymentCurrenciesItem];


export const UpdateFullPreferencesDtoApplyCriteriaPaymentCurrenciesItem = {
  BRL: 'BRL',
  USD: 'USD',
  EUR: 'EUR',
  GBP: 'GBP',
