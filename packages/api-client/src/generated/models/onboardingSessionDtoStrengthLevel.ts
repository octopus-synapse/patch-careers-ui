...
export type OnboardingSessionDtoStrengthLevel = typeof OnboardingSessionDtoStrengthLevel[keyof typeof OnboardingSessionDtoStrengthLevel];


export const OnboardingSessionDtoStrengthLevel = {
  weak: 'weak',
  growing: 'growing',
  strong: 'strong',
  excellent: 'excellent',
