...
export type UpdateFitQuestionDtoScaleType = typeof UpdateFitQuestionDtoScaleType[keyof typeof UpdateFitQuestionDtoScaleType];


export const UpdateFitQuestionDtoScaleType = {
  likert5: 'likert5',
  binary: 'binary',
} as const;
