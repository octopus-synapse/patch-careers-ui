 ...
 */
import type { FeatureFlagEvaluationDtoFlags } from './featureFlagEvaluationDtoFlags';

export interface FeatureFlagEvaluationDto {
  /** Map of flag key to effective boolean state for the calling user. */
  flags: FeatureFlagEvaluationDtoFlags;
}
