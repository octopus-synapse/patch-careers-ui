 ...
 */
import type { OnboardingSessionDtoStrengthLevel } from './onboardingSessionDtoStrengthLevel';

export type OnboardingSessionDtoStrength = {
  /**
     * @minimum 0
     * @maximum 100
     */
  score: number;
  message: string;
  level: OnboardingSessionDtoStrengthLevel;
};
