...
export type CreatePostDtoAnonymousCategory = typeof CreatePostDtoAnonymousCategory[keyof typeof CreatePostDtoAnonymousCategory];


export const CreatePostDtoAnonymousCategory = {
  SALARY: 'SALARY',
  INTERVIEW: 'INTERVIEW',
  LAYOFF: 'LAYOFF',
