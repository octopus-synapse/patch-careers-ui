 ...
 */
import type { NetworkSummaryDataDtoSuggestionsDataItem } from './networkSummaryDataDtoSuggestionsDataItem';

export type NetworkSummaryDataDtoSuggestions = {
  data: NetworkSummaryDataDtoSuggestionsDataItem[];
  total: number;
  page: number;
  limit: number;
  totalPages: number;
