 ...
 */
import type { MatchCandidatesDataDtoCandidatesItem } from './matchCandidatesDataDtoCandidatesItem';

export interface MatchCandidatesDataDto {
  candidates: MatchCandidatesDataDtoCandidatesItem[];
  poolSize: number;
}
