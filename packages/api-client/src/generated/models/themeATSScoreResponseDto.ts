 ...
 */
import type { ThemeATSScoreResponseDtoBreakdown } from './themeATSScoreResponseDtoBreakdown';

export interface ThemeATSScoreResponseDto {
  ...
  /**
     ...
     */
  overallScore: number;
  /** Whether the theme is considered ATS-friendly (score >= 80) */
  isATSFriendly: boolean;
  /** Detailed score breakdown by criteria */
  breakdown: ThemeATSScoreResponseDtoBreakdown;
