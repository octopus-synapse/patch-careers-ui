 ...
 */
import type { TrackEventsBodyDtoEventsItemProps } from './trackEventsBodyDtoEventsItemProps';

export type TrackEventsBodyDtoEventsItem = {
  /**
     * @minLength 1
     * @maxLength 120
     */
  event: string;
  props?: TrackEventsBodyDtoEventsItemProps;
  occurredAt: string;
};
