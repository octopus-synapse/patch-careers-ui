 ...
 */
import type { SpokenLanguageListDataDtoItemsItem } from './spokenLanguageListDataDtoItemsItem';

export interface SpokenLanguageListDataDto {
  items: SpokenLanguageListDataDtoItemsItem[];
  total: number;
  page: number;
  pageSize: number;
  totalPages: number;
