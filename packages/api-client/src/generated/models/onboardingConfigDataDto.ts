 ...
 */
import type { OnboardingConfigDataDtoConfig } from './onboardingConfigDataDtoConfig';

export interface OnboardingConfigDataDto {
  /** @nullable */
  config: OnboardingConfigDataDtoConfig;
}
