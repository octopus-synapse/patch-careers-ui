 ...
 */
import type { OnboardingStepListDataDtoStepsItem } from './onboardingStepListDataDtoStepsItem';

export interface OnboardingStepListDataDto {
  steps: OnboardingStepListDataDtoStepsItem[];
}
