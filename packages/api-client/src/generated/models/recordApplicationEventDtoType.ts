...
export type RecordApplicationEventDtoType = typeof RecordApplicationEventDtoType[keyof typeof RecordApplicationEventDtoType];


export const RecordApplicationEventDtoType = {
  VIEWED: 'VIEWED',
