 ...
 */
import type { FitQuestionListResponseDtoItemsItemDimension } from './fitQuestionListResponseDtoItemsItemDimension';
import type { FitQuestionListResponseDtoItemsItemScaleType } from './fitQuestionListResponseDtoItemsItemScaleType';

export type FitQuestionListResponseDtoItemsItem = {
  id: string;
  key: string;
  dimension: FitQuestionListResponseDtoItemsItemDimension;
  textEn: string;
  textPtBr: string;
  scaleType: FitQuestionListResponseDtoItemsItemScaleType;
  weight: number;
  isActive: boolean;
