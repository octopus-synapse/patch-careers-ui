...
export type FitProfileMeResponseDtoStatus = typeof FitProfileMeResponseDtoStatus[keyof typeof FitProfileMeResponseDtoStatus];


export const FitProfileMeResponseDtoStatus = {
  never: 'never',
  responded: 'responded',
  expired: 'expired',
} as const;
