 ...
 */
import type { ResumeListDataDtoResumesItemResumeSectionsItemItemsItem } from './resumeListDataDtoResumesItemResumeSectionsItemItemsItem';
import type { ResumeListDataDtoResumesItemResumeSectionsItemSectionType } from './resumeListDataDtoResumesItemResumeSectionsItemSectionType';

export type ResumeListDataDtoResumesItemResumeSectionsItem = {
  id: string;
  resumeId: string;
  ...
  createdAt: unknown;
  updatedAt: unknown;
  sectionType: ResumeListDataDtoResumesItemResumeSectionsItemSectionType;
  items: ResumeListDataDtoResumesItemResumeSectionsItemItemsItem[];
};
