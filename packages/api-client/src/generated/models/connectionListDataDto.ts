 ...
 */
import type { ConnectionListDataDtoConnections } from './connectionListDataDtoConnections';

export interface ConnectionListDataDto {
  connections: ConnectionListDataDtoConnections;
}
