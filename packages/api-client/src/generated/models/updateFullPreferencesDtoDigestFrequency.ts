...
export type UpdateFullPreferencesDtoDigestFrequency = typeof UpdateFullPreferencesDtoDigestFrequency[keyof typeof UpdateFullPreferencesDtoDigestFrequency];


export const UpdateFullPreferencesDtoDigestFrequency = {
  DAILY: 'DAILY',
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
} as const;
