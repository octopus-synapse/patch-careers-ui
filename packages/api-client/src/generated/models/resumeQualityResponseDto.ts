 ...
 */
import type { ResumeQualityResponseDtoIssuesItem } from './resumeQualityResponseDtoIssuesItem';

export interface ResumeQualityResponseDto {
  id: string;
  resumeId: string;
  /**
     * @minimum 0
  ...
  issues: ResumeQualityResponseDtoIssuesItem[];
