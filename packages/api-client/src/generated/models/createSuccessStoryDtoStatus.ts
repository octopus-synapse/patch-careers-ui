...
export type CreateSuccessStoryDtoStatus = typeof CreateSuccessStoryDtoStatus[keyof typeof CreateSuccessStoryDtoStatus];


export const CreateSuccessStoryDtoStatus = {
  DRAFT: 'DRAFT',
