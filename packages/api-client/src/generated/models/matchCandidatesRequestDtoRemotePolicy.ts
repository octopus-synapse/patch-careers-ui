...
export type MatchCandidatesRequestDtoRemotePolicy = typeof MatchCandidatesRequestDtoRemotePolicy[keyof typeof MatchCandidatesRequestDtoRemotePolicy];


export const MatchCandidatesRequestDtoRemotePolicy = {
  REMOTE: 'REMOTE',
  HYBRID: 'HYBRID',
  ONSITE: 'ONSITE',
} as const;
