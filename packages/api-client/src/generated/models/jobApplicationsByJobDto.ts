 ...
 */
import type { JobApplicationsByJobDtoItemsItem } from './jobApplicationsByJobDtoItemsItem';
import type { JobApplicationsByJobDtoPagination } from './jobApplicationsByJobDtoPagination';

export interface JobApplicationsByJobDto {
  items: JobApplicationsByJobDtoItemsItem[];
  pagination: JobApplicationsByJobDtoPagination;
}
