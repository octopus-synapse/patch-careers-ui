 ...
 */
import type { MatchBreakdownDtoSubScoresSemanticDetail } from './matchBreakdownDtoSubScoresSemanticDetail';

export type MatchBreakdownDtoSubScoresSemantic = {
  /**
     * @minimum 0
     * @maximum 100
     * @nullable
     */
  score: number | null;
  detail?: MatchBreakdownDtoSubScoresSemanticDetail;
};
