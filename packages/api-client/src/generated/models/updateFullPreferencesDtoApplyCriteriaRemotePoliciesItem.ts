...
export type UpdateFullPreferencesDtoApplyCriteriaRemotePoliciesItem = typeof UpdateFullPreferencesDtoApplyCriteriaRemotePoliciesItem[keyof typeof UpdateFullPreferencesDtoApplyCriteriaRemotePoliciesItem];


export const UpdateFullPreferencesDtoApplyCriteriaRemotePoliciesItem = {
  REMOTE: 'REMOTE',
  HYBRID: 'HYBRID',
  ONSITE: 'ONSITE',
} as const;
