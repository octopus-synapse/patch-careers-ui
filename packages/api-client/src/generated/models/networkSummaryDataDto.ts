 ...
 */
import type { NetworkSummaryDataDtoConnections } from './networkSummaryDataDtoConnections';
import type { NetworkSummaryDataDtoPendingRequests } from './networkSummaryDataDtoPendingRequests';
import type { NetworkSummaryDataDtoStats } from './networkSummaryDataDtoStats';
import type { NetworkSummaryDataDtoSuggestions } from './networkSummaryDataDtoSuggestions';

export interface NetworkSummaryDataDto {
  stats: NetworkSummaryDataDtoStats;
  pendingRequests: NetworkSummaryDataDtoPendingRequests;
  connections: NetworkSummaryDataDtoConnections;
  suggestions: NetworkSummaryDataDtoSuggestions;
}
