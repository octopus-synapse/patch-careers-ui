 ...
 */
import type { StyleListResponseDtoItemsItemLayoutKind } from './styleListResponseDtoItemsItemLayoutKind';

export type StyleListResponseDtoItemsItem = {
  id: string;
  name: string;
  /** @nullable */
  ...
  /**
     ...
     */
  styleScore: number;
  layoutKind: StyleListResponseDtoItemsItemLayoutKind;
