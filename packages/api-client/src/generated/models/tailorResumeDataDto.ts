 ...
 */
import type { TailorResumeDataDtoBulletsItem } from './tailorResumeDataDtoBulletsItem';

export interface TailorResumeDataDto {
  versionId: string;
  ...
  bullets: TailorResumeDataDtoBulletsItem[];
}
