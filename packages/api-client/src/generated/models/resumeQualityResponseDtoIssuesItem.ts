 ...
 */
import type { ResumeQualityResponseDtoIssuesItemContext } from './resumeQualityResponseDtoIssuesItemContext';
import type { ResumeQualityResponseDtoIssuesItemMessageArgs } from './resumeQualityResponseDtoIssuesItemMessageArgs';
import type { ResumeQualityResponseDtoIssuesItemSeverity } from './resumeQualityResponseDtoIssuesItemSeverity';

export type ResumeQualityResponseDtoIssuesItem = {
  code: string;
  severity: ResumeQualityResponseDtoIssuesItemSeverity;
  messageArgs?: ResumeQualityResponseDtoIssuesItemMessageArgs;
  freeformMessage?: string;
  context?: ResumeQualityResponseDtoIssuesItemContext;
};
