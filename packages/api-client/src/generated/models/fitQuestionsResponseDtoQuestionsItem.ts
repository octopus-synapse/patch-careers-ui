 ...
 */
import type { FitQuestionsResponseDtoQuestionsItemDimension } from './fitQuestionsResponseDtoQuestionsItemDimension';
import type { FitQuestionsResponseDtoQuestionsItemScaleType } from './fitQuestionsResponseDtoQuestionsItemScaleType';

export type FitQuestionsResponseDtoQuestionsItem = {
  id: string;
  key: string;
  dimension: FitQuestionsResponseDtoQuestionsItemDimension;
  textEn: string;
  textPtBr: string;
  scaleType: FitQuestionsResponseDtoQuestionsItemScaleType;
  weight: number;
};
