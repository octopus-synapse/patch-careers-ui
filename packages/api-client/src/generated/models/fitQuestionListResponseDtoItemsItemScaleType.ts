...
export type FitQuestionListResponseDtoItemsItemScaleType = typeof FitQuestionListResponseDtoItemsItemScaleType[keyof typeof FitQuestionListResponseDtoItemsItemScaleType];


export const FitQuestionListResponseDtoItemsItemScaleType = {
  likert5: 'likert5',
  binary: 'binary',
} as const;
