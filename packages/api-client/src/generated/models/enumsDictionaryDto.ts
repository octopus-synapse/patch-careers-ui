 ...
 */
import type { EnumsDictionaryDtoEntries } from './enumsDictionaryDtoEntries';
import type { EnumsDictionaryDtoLocale } from './enumsDictionaryDtoLocale';

export interface EnumsDictionaryDto {
  /** Locale the strings are in (negotiated from Accept-Language). */
  locale: EnumsDictionaryDtoLocale;
  /** Map from Prisma enum name to its `{ value → label }` map in the negotiated locale. */
  entries: EnumsDictionaryDtoEntries;
}
