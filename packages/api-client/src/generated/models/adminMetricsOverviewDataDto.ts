 ...
 */
import type { AdminMetricsOverviewDataDtoCounters } from './adminMetricsOverviewDataDtoCounters';
import type { AdminMetricsOverviewDataDtoGauges } from './adminMetricsOverviewDataDtoGauges';
import type { AdminMetricsOverviewDataDtoLatencyItem } from './adminMetricsOverviewDataDtoLatencyItem';
import type { AdminMetricsOverviewDataDtoProcess } from './adminMetricsOverviewDataDtoProcess';

export interface AdminMetricsOverviewDataDto {
  counters: AdminMetricsOverviewDataDtoCounters;
  gauges: AdminMetricsOverviewDataDtoGauges;
  process: AdminMetricsOverviewDataDtoProcess;
  latency: AdminMetricsOverviewDataDtoLatencyItem[];
}
