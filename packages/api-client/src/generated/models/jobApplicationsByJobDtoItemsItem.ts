 ...
 */
import type { JobApplicationsByJobDtoItemsItemStatus } from './jobApplicationsByJobDtoItemsItemStatus';
import type { JobApplicationsByJobDtoItemsItemUser } from './jobApplicationsByJobDtoItemsItemUser';

export type JobApplicationsByJobDtoItemsItem = {
  id: string;
  status: JobApplicationsByJobDtoItemsItemStatus;
  createdAt: string;
  /** @nullable */
  ...
  /** @nullable */
  user: JobApplicationsByJobDtoItemsItemUser;
};
