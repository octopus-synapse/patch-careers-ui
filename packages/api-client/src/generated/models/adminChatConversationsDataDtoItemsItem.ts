 ...
 */
import type { AdminChatConversationsDataDtoItemsItemParticipant1 } from './adminChatConversationsDataDtoItemsItemParticipant1';
import type { AdminChatConversationsDataDtoItemsItemParticipant2 } from './adminChatConversationsDataDtoItemsItemParticipant2';

export type AdminChatConversationsDataDtoItemsItem = {
  id: string;
  createdAt: string;
  updatedAt: string;
  participant1Id: string;
  participant2Id: string;
  participant1: AdminChatConversationsDataDtoItemsItemParticipant1;
  participant2: AdminChatConversationsDataDtoItemsItemParticipant2;
  /** @nullable */
