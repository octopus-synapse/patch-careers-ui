 ...
 */
import type { AdminChatConversationsDataDtoItemsItem } from './adminChatConversationsDataDtoItemsItem';

export interface AdminChatConversationsDataDto {
  items: AdminChatConversationsDataDtoItemsItem[];
  total: number;
  page: number;
  pageSize: number;
  totalPages: number;
