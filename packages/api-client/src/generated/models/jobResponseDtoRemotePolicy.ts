 ...
 * @nullable
 */
export type JobResponseDtoRemotePolicy = typeof JobResponseDtoRemotePolicy[keyof typeof JobResponseDtoRemotePolicy] | null;


export const JobResponseDtoRemotePolicy = {
  REMOTE: 'REMOTE',
  HYBRID: 'HYBRID',
  ONSITE: 'ONSITE',
} as const;
