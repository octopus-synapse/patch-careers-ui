 ...
 */
import type { FitQuestionResponseDtoDimension } from './fitQuestionResponseDtoDimension';
import type { FitQuestionResponseDtoScaleType } from './fitQuestionResponseDtoScaleType';

export interface FitQuestionResponseDto {
  id: string;
  key: string;
  dimension: FitQuestionResponseDtoDimension;
  textEn: string;
  textPtBr: string;
  scaleType: FitQuestionResponseDtoScaleType;
  weight: number;
  isActive: boolean;
