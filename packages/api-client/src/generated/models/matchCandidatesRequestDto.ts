 ...
 */
import type { MatchCandidatesRequestDtoMinEnglishLevel } from './matchCandidatesRequestDtoMinEnglishLevel';
import type { MatchCandidatesRequestDtoRemotePolicy } from './matchCandidatesRequestDtoRemotePolicy';

export interface MatchCandidatesRequestDto {
  /** @maxLength 200 */
  jobTitle?: string;
  /** @maxLength 20000 */
  ...
  /** @maxItems 40 */
  skills?: string[];
  minEnglishLevel?: MatchCandidatesRequestDtoMinEnglishLevel;
  remotePolicy?: MatchCandidatesRequestDtoRemotePolicy;
  /**
     * @minimum 1
     * @maximum 25
     */
