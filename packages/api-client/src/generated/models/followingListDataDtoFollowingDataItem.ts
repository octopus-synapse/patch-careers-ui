 ...
 */
import type { FollowingListDataDtoFollowingDataItemFollowing } from './followingListDataDtoFollowingDataItemFollowing';

export type FollowingListDataDtoFollowingDataItem = {
  id: string;
  followerId: string;
  followingId: string;
  createdAt: string | unknown;
  following?: FollowingListDataDtoFollowingDataItemFollowing;
