 ...
 */
import type { ShareAnalyticsSummaryDataDtoAnalyticsRecentEventsItemEvent } from './shareAnalyticsSummaryDataDtoAnalyticsRecentEventsItemEvent';

export type ShareAnalyticsSummaryDataDtoAnalyticsRecentEventsItem = {
  event: ShareAnalyticsSummaryDataDtoAnalyticsRecentEventsItemEvent;
  /** @nullable */
  country: string | null;
  /** @nullable */
  city: string | null;
