 ...
 */
import type { CreateFitQuestionDtoDimension } from './createFitQuestionDtoDimension';
import type { CreateFitQuestionDtoScaleType } from './createFitQuestionDtoScaleType';

export interface CreateFitQuestionDto {
  /**
     * @minLength 1
     * @maxLength 120
     */
  key: string;
  dimension: CreateFitQuestionDtoDimension;
  /** @minLength 1 */
  textEn: string;
  /** @minLength 1 */
  textPtBr: string;
  scaleType: CreateFitQuestionDtoScaleType;
  /** @exclusiveMinimum 0 */
  weight?: number;
  isActive?: boolean;
