 ...
 */
import type { OnboardingStatsDataDtoStatsDropOffByStep } from './onboardingStatsDataDtoStatsDropOffByStep';

export type OnboardingStatsDataDtoStats = {
  totalStarted: number;
  totalCompleted: number;
  completionRate: number;
  dropOffByStep: OnboardingStatsDataDtoStatsDropOffByStep;
};
