...
export type MatchCandidatesRequestDtoMinEnglishLevel = typeof MatchCandidatesRequestDtoMinEnglishLevel[keyof typeof MatchCandidatesRequestDtoMinEnglishLevel];


export const MatchCandidatesRequestDtoMinEnglishLevel = {
  BASIC: 'BASIC',
