 ...
 */
import type { SubmitFitAnswersDtoAnswersItem } from './submitFitAnswersDtoAnswersItem';

export interface SubmitFitAnswersDto {
  questionSetId: string;
  answers: SubmitFitAnswersDtoAnswersItem[];
}
