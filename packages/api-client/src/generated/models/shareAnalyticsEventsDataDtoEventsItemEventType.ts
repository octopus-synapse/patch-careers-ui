...
export type ShareAnalyticsEventsDataDtoEventsItemEventType = typeof ShareAnalyticsEventsDataDtoEventsItemEventType[keyof typeof ShareAnalyticsEventsDataDtoEventsItemEventType];


export const ShareAnalyticsEventsDataDtoEventsItemEventType = {
  VIEW: 'VIEW',
  DOWNLOAD: 'DOWNLOAD',
} as const;
