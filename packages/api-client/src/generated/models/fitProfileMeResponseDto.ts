 ...
 */
import type { FitProfileMeResponseDtoStatus } from './fitProfileMeResponseDtoStatus';
import type { FitProfileMeResponseDtoVector } from './fitProfileMeResponseDtoVector';

export interface FitProfileMeResponseDto {
  status: FitProfileMeResponseDtoStatus;
  /** @nullable */
  vector: FitProfileMeResponseDtoVector;
  /** @nullable */
