 ...
 */
import type { TailoredVersionsListDataDtoVersionsItem } from './tailoredVersionsListDataDtoVersionsItem';

export interface TailoredVersionsListDataDto {
  versions: TailoredVersionsListDataDtoVersionsItem[];
}
