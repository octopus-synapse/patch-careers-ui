 ...
 */
import type { ResumeDetailsDataDtoResumeResumeSectionsItemItemsItem } from './resumeDetailsDataDtoResumeResumeSectionsItemItemsItem';
import type { ResumeDetailsDataDtoResumeResumeSectionsItemSectionType } from './resumeDetailsDataDtoResumeResumeSectionsItemSectionType';

export type ResumeDetailsDataDtoResumeResumeSectionsItem = {
  id: string;
  resumeId: string;
  ...
  createdAt: unknown;
  updatedAt: unknown;
  sectionType: ResumeDetailsDataDtoResumeResumeSectionsItemSectionType;
  items: ResumeDetailsDataDtoResumeResumeSectionsItemItemsItem[];
};
