 ...
 */
import type { JobFitProfileResponseDtoVector } from './jobFitProfileResponseDtoVector';

export interface JobFitProfileResponseDto {
  id: string;
  jobId: string;
  editedByUserId: string;
  computedAt: string;
  vector: JobFitProfileResponseDtoVector;
}
