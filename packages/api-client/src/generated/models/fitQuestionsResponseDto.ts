 ...
 */
import type { FitQuestionsResponseDtoQuestionsItem } from './fitQuestionsResponseDtoQuestionsItem';

export interface FitQuestionsResponseDto {
  questionSetId: string;
  seed: string;
  createdAt: string;
  questions: FitQuestionsResponseDtoQuestionsItem[];
}
