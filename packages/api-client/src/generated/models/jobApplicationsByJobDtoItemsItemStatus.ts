...
export type JobApplicationsByJobDtoItemsItemStatus = typeof JobApplicationsByJobDtoItemsItemStatus[keyof typeof JobApplicationsByJobDtoItemsItemStatus];


export const JobApplicationsByJobDtoItemsItemStatus = {
  SUBMITTED: 'SUBMITTED',
  VIEWED: 'VIEWED',
  REJECTED: 'REJECTED',
  ACCEPTED: 'ACCEPTED',
