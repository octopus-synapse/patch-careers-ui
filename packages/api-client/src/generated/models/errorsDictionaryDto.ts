 ...
 */
import type { ErrorsDictionaryDtoEntries } from './errorsDictionaryDtoEntries';
import type { ErrorsDictionaryDtoLocale } from './errorsDictionaryDtoLocale';

export interface ErrorsDictionaryDto {
  /** Locale the strings are in (negotiated from Accept-Language). */
  locale: ErrorsDictionaryDtoLocale;
  /** Map from stable error code to the localized message. */
  entries: ErrorsDictionaryDtoEntries;
}
