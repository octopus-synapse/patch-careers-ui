 ...
 * @nullable
 */
export type PaginatedJobsDtoItemsItemPaymentCurrency = typeof PaginatedJobsDtoItemsItemPaymentCurrency[keyof typeof PaginatedJobsDtoItemsItemPaymentCurrency] | null;


export const PaginatedJobsDtoItemsItemPaymentCurrency = {
  BRL: 'BRL',
  USD: 'USD',
  EUR: 'EUR',
  GBP: 'GBP',
