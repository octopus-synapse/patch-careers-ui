 ...
 */
import type { AdminCollaborationsListDataDtoItemsItem } from './adminCollaborationsListDataDtoItemsItem';

export interface AdminCollaborationsListDataDto {
  items: AdminCollaborationsListDataDtoItemsItem[];
  total: number;
  page: number;
  pageSize: number;
  totalPages: number;
