 ...
 */
import type { MatchBreakdownDtoSubScoresRequirementsDetail } from './matchBreakdownDtoSubScoresRequirementsDetail';

export type MatchBreakdownDtoSubScoresRequirements = {
  /**
     * @minimum 0
     * @maximum 100
     * @nullable
     */
  score: number | null;
  detail?: MatchBreakdownDtoSubScoresRequirementsDetail;
};
