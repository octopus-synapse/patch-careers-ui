 ...
 */
import type { ChatUserSearchDataDtoUsersItem } from './chatUserSearchDataDtoUsersItem';

export interface ChatUserSearchDataDto {
  users: ChatUserSearchDataDtoUsersItem[];
}
