...
export type ThemesFindAllThemesWithPaginationSortDir = typeof ThemesFindAllThemesWithPaginationSortDir[keyof typeof ThemesFindAllThemesWithPaginationSortDir];


export const ThemesFindAllThemesWithPaginationSortDir = {
  asc: 'asc',
  desc: 'desc',
} as const;
