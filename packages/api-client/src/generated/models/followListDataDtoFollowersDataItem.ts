 ...
 */
import type { FollowListDataDtoFollowersDataItemFollower } from './followListDataDtoFollowersDataItemFollower';

export type FollowListDataDtoFollowersDataItem = {
  id: string;
  followerId: string;
  followingId: string;
  createdAt: string | unknown;
  follower?: FollowListDataDtoFollowersDataItemFollower;
