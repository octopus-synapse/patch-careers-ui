...
export type FitQuestionResponseDtoScaleType = typeof FitQuestionResponseDtoScaleType[keyof typeof FitQuestionResponseDtoScaleType];


export const FitQuestionResponseDtoScaleType = {
  likert5: 'likert5',
  binary: 'binary',
} as const;
