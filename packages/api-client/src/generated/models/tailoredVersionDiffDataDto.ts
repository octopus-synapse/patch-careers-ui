 ...
 */
import type { TailoredVersionDiffDataDtoBulletsItem } from './tailoredVersionDiffDataDtoBulletsItem';
import type { TailoredVersionDiffDataDtoJobTitle } from './tailoredVersionDiffDataDtoJobTitle';
import type { TailoredVersionDiffDataDtoSummary } from './tailoredVersionDiffDataDtoSummary';

export interface TailoredVersionDiffDataDto {
  versionId: string;
  /** @nullable */
  summary: TailoredVersionDiffDataDtoSummary;
  /** @nullable */
  jobTitle: TailoredVersionDiffDataDtoJobTitle;
  bullets: TailoredVersionDiffDataDtoBulletsItem[];
}
