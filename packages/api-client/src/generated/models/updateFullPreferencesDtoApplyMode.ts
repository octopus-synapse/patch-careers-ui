...
export type UpdateFullPreferencesDtoApplyMode = typeof UpdateFullPreferencesDtoApplyMode[keyof typeof UpdateFullPreferencesDtoApplyMode];


export const UpdateFullPreferencesDtoApplyMode = {
  ONE_CLICK: 'ONE_CLICK',
