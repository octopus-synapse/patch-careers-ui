 ...
 */
export type NotificationsDictionaryDtoLocale = typeof NotificationsDictionaryDtoLocale[keyof typeof NotificationsDictionaryDtoLocale];


export const NotificationsDictionaryDtoLocale = {
  en: 'en',
  'pt-BR': 'pt-BR',
} as const;
