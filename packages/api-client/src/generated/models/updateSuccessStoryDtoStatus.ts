...
export type UpdateSuccessStoryDtoStatus = typeof UpdateSuccessStoryDtoStatus[keyof typeof UpdateSuccessStoryDtoStatus];


export const UpdateSuccessStoryDtoStatus = {
  DRAFT: 'DRAFT',
