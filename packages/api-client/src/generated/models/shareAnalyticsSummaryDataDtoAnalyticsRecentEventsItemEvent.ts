...
export type ShareAnalyticsSummaryDataDtoAnalyticsRecentEventsItemEvent = typeof ShareAnalyticsSummaryDataDtoAnalyticsRecentEventsItemEvent[keyof typeof ShareAnalyticsSummaryDataDtoAnalyticsRecentEventsItemEvent];


export const ShareAnalyticsSummaryDataDtoAnalyticsRecentEventsItemEvent = {
  VIEW: 'VIEW',
  DOWNLOAD: 'DOWNLOAD',
} as const;
