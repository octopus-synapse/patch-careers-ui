 ...
 */
export const skillsSetBodyYearsOfExperienceMin = 0;
export const skillsSetBodyYearsOfExperienceMax = 80;



export const SkillsSetBody = zod.object({
  "proficiency": zod.enum(['BEGINNER', 'INTERMEDIATE', 'ADVANCED', 'EXPERT']),
  "yearsOfExperience": zod.number().min(skillsSetBodyYearsOfExperienceMin).max(skillsSetBodyYearsOfExperienceMax).optional()
})
