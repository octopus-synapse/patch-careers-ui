...
export const TechSkillsSearchSkillsResponse = zod.object({
 ...
 */
export const TechSkillsGetSkillsResponse = zod.object({
  "items": zod.array(zod.object({
  "id": zod.string(),
  "slug": zod.string(),
  "nameEn": zod.string(),
 ...
 */
export const TechSkillsGetSkillsByTypeResponse = zod.object({
  "items": zod.array(zod.object({
  "id": zod.string(),
  "slug": zod.string(),
  "nameEn": zod.string(),
