 ...
 */
export const AdminCollaborationsGetStatsResponse = zod.object({
 ...
 */
export const AdminCollaborationsGetCollaborationsResponse = zod.object({
  ...
  "invitedAt": zod.string().datetime({}),
  "joinedAt": zod.string().datetime({}).nullable(),
  "user": zod.object({
  "id": zod.string(),
