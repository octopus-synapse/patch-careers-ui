 ...
 */
export const FeatureFlagsEvaluateResponse = zod.object({
  "flags": zod.record(zod.string(), zod.boolean()).describe('Map of flag key to effective boolean state for the calling user.')
})
