 ...
 */
export const MecMetadataListAllStateCodesResponse = zod.object({
 ...
 */
export const MecMetadataListAllKnowledgeAreasResponse = zod.object({
 ...
 */
export const MecMetadataGetMecStatisticsResponse = zod.object({
  "stats": zod.object({
