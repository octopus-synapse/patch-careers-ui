...
import type { PostV1OnboardingSessionRestart201, PostV1OnboardingSessionRestart400, PostV1OnboardingSessionRestart401, PostV1OnboardingSessionRestartMutationResponse, PostV1OnboardingSessionRestartQueryParams } from "../../models/onboardingController/PostV1OnboardingSessionRestart";
import { phoneSchema } from "../phoneSchema";
import { userLocationSchema } from "../userLocationSchema";

export const postV1OnboardingSessionRestartQueryParamsSchema = z.object({
    "locale": z.optional(z.string()),
"mode": z.optional(z.enum(["clean"]))
    }).optional() as unknown as ToZod<PostV1OnboardingSessionRestartQueryParams>

/**
 * @description Successful response
 */
export const postV1OnboardingSessionRestart201Schema = z.object({
...
"colorScheme": z.optional(z.string())
    ...
    }) as unknown as ToZod<PostV1OnboardingSessionRestart201>

/**
 * @description Validation error
 */
export const postV1OnboardingSessionRestart400Schema = z.object({
    "statusCode": z.number().int(),
"code": z.string(),
"message": z.string(),
"severity": z.enum(["toast", "modal", "banner", "inline", "silent"])
    }) as unknown as ToZod<PostV1OnboardingSessionRestart400>

/**
 * @description Authentication required
 */
export const postV1OnboardingSessionRestart401Schema = z.object({
    "statusCode": z.number().int(),
"code": z.string(),
"message": z.string(),
"severity": z.enum(["toast", "modal", "banner", "inline", "silent"])
    }) as unknown as ToZod<PostV1OnboardingSessionRestart401>

export const postV1OnboardingSessionRestartMutationResponseSchema = z.lazy(() => postV1OnboardingSessionRestart201Schema) as unknown as ToZod<PostV1OnboardingSessionRestartMutationResponse>