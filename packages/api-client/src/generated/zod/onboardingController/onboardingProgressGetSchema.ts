...
import type { OnboardingProgressGet200, OnboardingProgressGet400, OnboardingProgressGet401, OnboardingProgressGetQueryResponse } from "../../models/onboardingController/OnboardingProgressGet";

/**
 * @description Successful response
 */
export const onboardingProgressGet200Schema = z.object({
...
"colorScheme": z.optional(z.string())
    ...
    }) as unknown as ToZod<OnboardingProgressGet200>

/**
 * @description Bad Request — validation failure
 */
export const onboardingProgressGet400Schema = z.object({
...
"message": z.string()
    ...
    }) as unknown as ToZod<OnboardingProgressGet400>

/**
 * @description Unauthorized
 */
export const onboardingProgressGet401Schema = z.object({
    "statusCode": z.number().int(),
"code": z.string(),
"message": z.string(),
"severity": z.enum(["toast", "modal", "banner", "inline", "silent"]),
...
"message": z.string()
    ...
    }) as unknown as ToZod<OnboardingProgressGet401>

export const onboardingProgressGetQueryResponseSchema = z.lazy(() => onboardingProgressGet200Schema) as unknown as ToZod<OnboardingProgressGetQueryResponse>