...
export const postV1OnboardingSessionSaveQueryParamsSchema = z.object({
    "locale": z.optional(z.string())
    }).optional() as unknown as ToZod<PostV1OnboardingSessionSaveQueryParams>

/**
 * @description Successful response
 */
export const postV1OnboardingSessionSave201Schema = z.object({
...
"colorScheme": z.optional(z.string())
    ...
    }) as unknown as ToZod<PostV1OnboardingSessionSave201>

/**
 * @description Validation error
 */
export const postV1OnboardingSessionSave400Schema = z.object({
    "statusCode": z.number().int(),
"code": z.string(),
"message": z.string(),
"severity": z.enum(["toast", "modal", "banner", "inline", "silent"])
    }) as unknown as ToZod<PostV1OnboardingSessionSave400>

/**
 * @description Authentication required
 */
export const postV1OnboardingSessionSave401Schema = z.object({
    "statusCode": z.number().int(),
"code": z.string(),
"message": z.string(),
"severity": z.enum(["toast", "modal", "banner", "inline", "silent"])
    }) as unknown as ToZod<PostV1OnboardingSessionSave401>

export const postV1OnboardingSessionSaveMutationRequestSchema = z.object({
    
    }).catchall(z.any().nullable()) as unknown as ToZod<PostV1OnboardingSessionSaveMutationRequest>

export const postV1OnboardingSessionSaveMutationResponseSchema = z.lazy(() => postV1OnboardingSessionSave201Schema) as unknown as ToZod<PostV1OnboardingSessionSaveMutationResponse>