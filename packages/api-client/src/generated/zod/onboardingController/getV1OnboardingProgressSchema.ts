...
import type { GetV1OnboardingProgress200, GetV1OnboardingProgress400, GetV1OnboardingProgress401, GetV1OnboardingProgressQueryResponse } from "../../models/onboardingController/GetV1OnboardingProgress";
 ...
 */
export const getV1OnboardingProgress200Schema = z.object({
...
"colorScheme": z.optional(z.string())
    ...
    }) as unknown as ToZod<GetV1OnboardingProgress200>

/**
 * @description Validation error
 */
export const getV1OnboardingProgress400Schema = z.object({
    "statusCode": z.number().int(),
"code": z.string(),
"message": z.string(),
"severity": z.enum(["toast", "modal", "banner", "inline", "silent"])
    }) as unknown as ToZod<GetV1OnboardingProgress400>

/**
 * @description Authentication required
 */
export const getV1OnboardingProgress401Schema = z.object({
    "statusCode": z.number().int(),
"code": z.string(),
"message": z.string(),
"severity": z.enum(["toast", "modal", "banner", "inline", "silent"])
    }) as unknown as ToZod<GetV1OnboardingProgress401>

export const getV1OnboardingProgressQueryResponseSchema = z.lazy(() => getV1OnboardingProgress200Schema) as unknown as ToZod<GetV1OnboardingProgressQueryResponse>