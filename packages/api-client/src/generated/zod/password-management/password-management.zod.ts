 ...
 */
export const ForgotPasswordHandleBody = zod.object({
...
export const resetPasswordHandleBodyNewPasswordMin = 8;



export const ResetPasswordHandleBody = zod.object({
...
export const changePasswordHandleBodyNewPasswordMin = 8;
