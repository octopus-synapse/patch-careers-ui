...
import type { DslRenderPublic200, DslRenderPublic400, DslRenderPublicPathParams, DslRenderPublicQueryParams, DslRenderPublicQueryResponse } from "../../models/dslController/DslRenderPublic";

export const dslRenderPublicPathParamsSchema = z.object({
    "slug": z.string()
    }) as unknown as ToZod<DslRenderPublicPathParams>

export const dslRenderPublicQueryParamsSchema = z.object({
    "target": z.optional(z.enum(["html", "pdf"])),
"locale": z.optional(z.string())
    }).optional() as unknown as ToZod<DslRenderPublicQueryParams>

/**
 * @description Successful response
 */
export const dslRenderPublic200Schema = z.object({
    "ast": z.object({
    "meta": z.object({
    "version": z.string(),
...
"accent": z.string()
    ...
    }) as unknown as ToZod<DslRenderPublic200>

/**
 * @description Bad Request — validation failure
 */
export const dslRenderPublic400Schema = z.object({
...
"message": z.string()
    ...
    }) as unknown as ToZod<DslRenderPublic400>

export const dslRenderPublicQueryResponseSchema = z.lazy(() => dslRenderPublic200Schema) as unknown as ToZod<DslRenderPublicQueryResponse>