 ...
 */
export const ActivityGetFeedResponse = zod.object({
  "feed": zod.object({
 ...
 */
export const ActivityGetUserActivitiesResponse = zod.object({
 ...
 */
export const ActivityGetActivitiesByTypeResponse = zod.object({
  "activities": zod.object({
  "data": zod.array(zod.unknown()),
  "total": zod.number(),
  "page": zod.number(),
