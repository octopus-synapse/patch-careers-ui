...
export const getForgotPasswordHandleMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof forgotPasswordHandle>>, TError,{data: ForgotPasswordDto}, TContext>, request?: SecondParameter<typeof customFetch>}
): CreateMutationOptions<Awaited<ReturnType<typeof forgotPasswordHandle>>, TError,{data: ForgotPasswordDto}, TContext> => {
 ...
 * @summary Request password reset
 */
export const createForgotPasswordHandle = <TError = unknown,
    TContext = unknown>(options?: () => { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof forgotPasswordHandle>>, TError,{data: ForgotPasswordDto}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: () => QueryClient): CreateMutationResult<
        ...
        TContext
      > => {
      return createMutation(() => ({ ...getForgotPasswordHandleMutationOptions(options?.()) }), queryClient);
    }
    /**
...
export const createResetPasswordHandle = <TError = void,
 ...
 , queryClient?: () => QueryClient): CreateMutationResult<
        ...
        TContext
      > => {
      return createMutation(() => ({ ...getResetPasswordHandleMutationOptions(options?.()) }), queryClient);
    }
    /**
...
export const createChangePasswordHandle = <TError = void,
 ...
 , queryClient?: () => QueryClient): CreateMutationResult<
        ...
        TContext
      > => {
      return createMutation(() => ({ ...getChangePasswordHandleMutationOptions(options?.()) }), queryClient);
    }
