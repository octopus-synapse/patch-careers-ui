...
export const getAuthSessionSuspenseQueryOptions = <TData = Awaited<ReturnType<typeof authSession>>, TError = unknown>( options?: { query?:Partial<CreateSuspenseQueryOptions<Awaited<ReturnType<typeof authSession>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAuthSessionQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as CreateSuspenseQueryOptions<Awaited<ReturnType<typeof authSession>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function createAuthSessionSuspense<TData = Awaited<ReturnType<typeof authSession>>, TError = unknown>(
  options?: () => { query?:Partial<CreateSuspenseQueryOptions<Awaited<ReturnType<typeof authSession>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: () => QueryClient
 ): CreateSuspenseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {



  const query = createQuery(() => getAuthSessionSuspenseQueryOptions(options?.()), queryClient) as CreateSuspenseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
