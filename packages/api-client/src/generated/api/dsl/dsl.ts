...
export const getDslValidateMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof dslValidate>>, TError,{data: string}, TContext>, request?: SecondParameter<typeof customFetch>}
): CreateMutationOptions<Awaited<ReturnType<typeof dslValidate>>, TError,{data: string}, TContext> => {
...
export const getDslPreviewMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof dslPreview>>, TError,{data: string;params?: DslPreviewParams}, TContext>, request?: SecondParameter<typeof customFetch>}
): CreateMutationOptions<Awaited<ReturnType<typeof dslPreview>>, TError,{data: string;params?: DslPreviewParams}, TContext> => {
