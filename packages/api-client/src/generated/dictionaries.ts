...
export const DICTIONARIES = {
  "errors": {
    ...
    "CONSENT_VERSION_MISMATCH": {
      ...
      "pt-BR": "Versão de consentimento incompatível — aceite os Termos de Uso e Política de Privacidade atuais"
    },
    ...
    "OAUTH_EMAIL_NOT_VERIFIED": {
      ...
      "pt-BR": "O e-mail do perfil OAuth ou da conta existente não foi verificado; vinculação manual necessária"
    },
    "OAUTH_STATE_INVALID": {
    ...
    "SKILL_IN_USE": {
      ...
      "pt-BR": "Não é possível apagar a habilidade — ela ainda é referenciada por currículos ou vagas"
    },
    ...
    "TYPST_WASM_RENDERER_NOT_IMPLEMENTED": {
      ...
      "pt-BR": "TypstWasmPdfRenderer ainda não foi implementado. Use o TypstCompilerService como fallback."
    },
    "UNAUTHORIZED": {
      "en": "Unauthorized",
  ...
  "notifications": {
    ...
    "FIT_PROFILE_EXPIRY_REMINDER": {
      ...
      "body": {
        ...
        "pt-BR": "Refaça o questionário antes de {expiresAt} para continuar usando o match sem interrupção."
      },
      "params": [
        "daysLeft",
        "expiresAt"
    ...
    "MATCH_RECOMMENDATIONS_READY": {
      ...
      "body": {
        ...
        "pt-BR": "Rankeamos as vagas mais recentes nas suas áreas de interesse. Top match: {topMatchTitle}."
      },
      "params": [
        "matchCount",
        "topMatchTitle"
    ...
    "RESUME_QUALITY_IMPROVED": {
      ...
      "body": {
        ...
        "pt-BR": "Seu novo snapshot ({newScore}/100) cruzou a faixa {previousRank} → {newRank}. Continua assim."
      },
      "params": [
        "newScore",
        "previousRank",
    ...
    "RESUME_QUALITY_REGRESSED": {
      ...
      "body": {
        ...
        "pt-BR": "Seu novo snapshot ({newScore}/100) cruzou a faixa {previousRank} → {newRank}. Abra o currículo pra ver o que mudou."
      },
      "params": [
        "newScore",
        "previousRank",
  ...
  "success": {
    "CREATED": {
      ...
      "pt-BR": "Resource created successfully"
    },
    "DELETED": {
      "en": "Resource deleted successfully",
      "pt-BR": "Resource deleted successfully"
    },
    "LOGIN_SUCCESS": {
      "en": "Login successful",
      "pt-BR": "Login successful"
    },
    "LOGOUT_SUCCESS": {
      "en": "Logout successful",
      "pt-BR": "Logout successful"
    },
    "ONBOARDING_COMPLETED": {
      "en": "Onboarding completed successfully",
      "pt-BR": "Onboarding completed successfully"
    },
    "UPDATED": {
      "en": "Resource updated successfully",
      "pt-BR": "Resource updated successfully"
    },
    "USER_REGISTERED": {
      "en": "User registered successfully",
      "pt-BR": "User registered successfully"
    }
  },
  "validation": {
    "ARRAY_REQUIRED": {
    ...
    "ARRAY_TOO_LONG": {
      "en": "Select at most {max} items",
      "pt-BR": "Selecione no máximo {max} itens"
    },
    "ARRAY_TOO_SHORT": {
      "en": "Select at least {min} items",
      "pt-BR": "Selecione ao menos {min} itens"
    },
    "CUID_INVALID": {
    ...
    "DATE_TOO_EARLY": {
      "en": "Date is too early",
      "pt-BR": "Data muito antiga"
    },
    "DATE_TOO_LATE": {
      "en": "Date is too late",
      "pt-BR": "Data muito distante"
    },
    "DATETIME_INVALID": {
      "en": "Invalid date/time",
      "pt-BR": "Data/hora inválida"
    },
    "EMAIL_INVALID": {
    ...
    "EMOJI_INVALID": {
      "en": "Must be an emoji",
      "pt-BR": "Deve ser um emoji"
    },
    "ENUM_INVALID": {
      "en": "Must be one of: {allowed}",
      "pt-BR": "Deve ser um de: {allowed}"
    },
    "FUNCTION_SIGNATURE_INVALID": {
      "en": "Invalid arguments",
      "pt-BR": "Argumentos inválidos"
    },
    "LITERAL_INVALID": {
      "en": "Unexpected value",
      "pt-BR": "Valor inesperado"
    },
    "MUST_BE_ARRAY": {
      "en": "Must be a list",
      "pt-BR": "Deve ser uma lista"
    },
    "MUST_BE_BIGINT": {
      "en": "Must be an integer",
      "pt-BR": "Deve ser um inteiro"
    },
    "MUST_BE_BOOLEAN": {
      "en": "Must be true or false",
      "pt-BR": "Deve ser verdadeiro ou falso"
    },
    "MUST_BE_DATE": {
      "en": "Must be a date",
      "pt-BR": "Deve ser uma data"
    },
    "MUST_BE_NUMBER": {
      "en": "Must be a number",
      "pt-BR": "Deve ser um número"
    },
    "MUST_BE_OBJECT": {
      "en": "Must be an object",
      "pt-BR": "Deve ser um objeto"
    },
    "MUST_BE_STRING": {
      "en": "Must be text",
      "pt-BR": "Deve ser um texto"
    },
    "NUMBER_NOT_FINITE": {
      "en": "Must be a finite number",
      "pt-BR": "Deve ser um número finito"
    },
    ...
    "PASSWORD_NEEDS_DIGIT": {
      ...
      "pt-BR": "Inclua ao menos um número"
    },
    ...
    "STRING_TOO_LONG": {
      "en": "Maximum of {max} characters",
      "pt-BR": "Máximo de {max} caracteres"
    },
    "STRING_TOO_SHORT": {
      "en": "Minimum of {min} characters",
      "pt-BR": "Mínimo de {min} caracteres"
    },
    "TYPE_MISMATCH": {
      "en": "Unexpected type",
      "pt-BR": "Tipo inesperado"
    },
    "UNION_INVALID": {
    ...
    "UNRECOGNIZED_KEYS": {
      "en": "Unexpected fields: {keys}",
      "pt-BR": "Campos inesperados: {keys}"
    },
    "URL_INVALID": {
      "en": "Enter a valid URL",
      "pt-BR": "Informe uma URL válida"
    },
    "UUID_INVALID": {
      "en": "Invalid identifier",
      "pt-BR": "Identificador inválido"
    ...
    "VALUE_TOO_LARGE": {
      ...
      "pt-BR": "Valor muito grande"
    },
    "VALUE_TOO_SMALL": {
      "en": "Value is too small",
      "pt-BR": "Valor muito pequeno"
    }
  }
} as const;
