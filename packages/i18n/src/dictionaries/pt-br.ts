...
export const ptBR: TranslationDict = {
  ...
  auth: {
    ...
    verifySendFailed: "Não foi possível enviar o código. Tente de novo.",
    verifyRateLimited: "Muitos pedidos de código. Aguarde alguns minutos e reenvie.",
    verifySendProblemTitle: "Código ainda não enviado",
    verifySendProblemIntro: "Não foi possível enviar um código para",
    verifySendingIntro: "Enviando um código de 6 dígitos para",
    verifySending: "Enviando seu código…",
    dialogUnavailableTitle: "Este acesso está indisponível.",
    dialogUnavailableBody:
      "Não é possível entrar com senha nesta conta agora. Use outro e-mail ou fale com o suporte.",
    signOut: "Sair",
    signUp: "Criar conta",
    ...
    consentAccept: "Concordar e criar minha conta",
    consentAcceptContinue: "Aceitar e continuar",
    ...
    forgotSuccessEyebrow: "Solicitação recebida",
    ...
    forgotSendFailed: "Não foi possível enviar o link. Confira a conexão e tente novamente.",
