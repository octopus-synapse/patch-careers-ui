...
export const profilePtBR: TranslationDict = {
  ...
  language: {
    ...
    translating: "Traduzindo… {done}/{total} seções",
    missing: "{count} itens ainda não traduzidos — mostrando o original",
    stale: "{count} itens desatualizados — atualizando",
    failed: "A tradução falhou. Troque de idioma de novo para tentar outra vez.",
    capReached: "Limite de tradução do mês atingido. O que já existe continua disponível.",
    unavailable: "Tradução indisponível no momento — mostrando o que já existe.",
  },
  publicProfile: {
...
export const profileEn: TranslationDict = {
  ...
  language: {
    ...
    translating: "Translating… {done}/{total} sections",
    missing: "{count} items not translated yet — showing the original",
    stale: "{count} items out of date — updating",
    failed: "Translation failed. Switch language again to retry.",
    capReached: "This month's translation limit is reached. What exists stays available.",
    unavailable: "Translation unavailable right now — showing what already exists.",
  },
  publicProfile: {
