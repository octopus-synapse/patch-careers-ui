...
export const jobsPtBR: TranslationDict = {
  ...
  applyFlow: {
    ...
    reviewDeltaNote:
      "Estimativa baseada nas palavras-chave do currículo, não na chance de entrevista.",
    changeTitle: "Título",
    changeSummary: "Resumo",
    changeBullet: "Bullet",
    changeKeywords: "Palavras-chave: {keywords}",
    coverLetterTitle: "Carta de apresentação",
    coverLetterNote: "Revise a carta antes de colá-la no formulário da empresa.",
    coverLetterCopy: "Copiar carta",
    coverLetterCopied: "Carta copiada.",
    coverLetterCopyError: "Não foi possível copiar a carta.",
...
export const jobsEn: TranslationDict = {
  ...
  applyFlow: {
    ...
    reviewDeltaNote: "Estimate based on resume keywords, not your chance of an interview.",
    changeTitle: "Title",
    changeSummary: "Summary",
    changeBullet: "Bullet",
    changeKeywords: "Keywords: {keywords}",
    coverLetterTitle: "Cover letter",
    coverLetterNote: "Review the letter before pasting it into the company's form.",
    coverLetterCopy: "Copy letter",
    coverLetterCopied: "Letter copied.",
    coverLetterCopyError: "Couldn't copy the letter.",
    reviewEmpty: "The AI found no changes that would improve your resume for this job.",
    reviewContinue: "Continue",
    reviewUseMaster: "Use the master anyway",
    readyTitle: "Ready to apply",
    readyMasterName: "Master resume",
    readySaved: "Saved in Resumes",
