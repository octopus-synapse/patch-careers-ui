...
export const en: TranslationDict = {
  ...
  auth: {
    ...
    verifySendFailed: "We couldn't send the code. Try again.",
    verifyRateLimited: "Too many code requests. Wait a few minutes and resend.",
    verifySendProblemTitle: "Code not sent yet",
    verifySendProblemIntro: "We couldn't send a code to",
    verifySendingIntro: "Sending a 6-digit code to",
    verifySending: "Sending your code…",
    dialogUnavailableTitle: "This sign-in is unavailable.",
    dialogUnavailableBody:
      "Password sign-in is unavailable for this account right now. Use another email or contact support.",
    signOut: "Sign out",
    ...
    consentAccept: "Agree and create my account",
    ...
    forgotSuccessEyebrow: "Request received",
    ...
    forgotSendFailed: "Couldn't send the link. Check your connection and try again.",
    ...
    resetFailed: "Couldn't update your password. Try again.",
